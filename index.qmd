...
If you're a Github user, you can fork and clone the workshop repository [here](https://github.com/JessicaBolin/esmrworkshop_rladies26). Then, you will then need to download the workshop data [here](/Users/admin/Dropbox/Rladieswebinar26/__data), which needs to be copied into the root directory. We've added the `/__data` folder to the `.gitignore` file within the root directory, since we'll be working with large files (and Github breaks when pushing/pulling large files).
